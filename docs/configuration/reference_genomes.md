# microarray-qc-workflow: Reference Genomes Configuration

The microarray-qc-workflow pipeline needs a reference genome for alignment and annotation. If not already available, start by downloading the relevant reference, for example from [illumina iGenomes](https://support.illumina.com/sequencing/sequencing_software/igenome.html).
...
```nextflow
includeConfig '/path/to/microarray-qc-workflow/conf/igenomes.config'
```
